...
function showData(data) {
    ...
    let tidyData = tempData.filter(d => isNaN(d.roll_dc) === false)
    ...
    svgPlot.append("text")
        ...
        .text(Math.round(maxVal[0].roll_dc))
        .style("fill", "#D55E00");
    ...
    if (deviceType() == "desktop") {
        ...
        rect.on("mouseover", function (d) {
            ...
            tooltip.append("text")
                .attr("x", 5)
                .attr("y", 32)
                .text(`Moyenne lissée: ${Math.round(d.roll_dc)}`)
                .attr("font-size", "10px")
                .attr("font-weight", "bold")
